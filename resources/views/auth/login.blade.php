            ...
            <div class="flex flex-col break-words bg-white border-2 shadow-md mt-20">
                ...
                <form class="py-10 px-5" method="POST" action="{{ route('login') }}" novalidate>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="email" type="email" class="p-3 bg-gray-200 rounded form-input w-full @error('email') border-red-500 border @enderror" name="email" value="{{ old('email') }}" sautocomplete="email" autofocus>
                    ...
                    <div class="flex flex-wrap mb-6">
                        <label for="password" class="black text-gray-700 text-sm mb-2">{{ __('Password') }}</label>
                        <input id="password" type="password" class="p-3 bg-gray-200 rounded form-input w-full @error('password') border-red-500 border @enderror" name="password" sautocomplete="current-password">
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <label class="black text-gray-700 text-sm mb-2" for="remember">
                            {{ __('Remember Me') }}
                        </label>
                    </div>
