    ...
    <div class="mt-10 mb-20 md:flex items-start">
        <div class="md:w-3/5">
            <p class="block text-gray-700 font-bold my-2">
                ...
                Por: <span class="font-normal"><a href="">{{$vacante->user->name}}</a></span>
            </p>
            <p class="block text-gray-700 font-bold my-2">
            ...
            <h2 class="text-2xl text-center mt-10 text-gray-700 mb-5">Conocimientos y Tecnologías</h1>
            @php
            ...
            <a href="{{ Storage::url($vacante->imagen) }}" data-lightbox="imagen" data-title="Vacante {{ $vacante->titulo }}">
                <img src="{{ Storage::url($vacante->imagen) }}" class="w-40 mt-10" alt="">
            </a>

            <h2 class="text-2xl text-center mt-10 text-gray-700 mb-5">Descripción</h1>
