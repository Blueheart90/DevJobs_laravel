...
@section('content')
    ...
    <form
        action="{{ route('vacantes.update', $vacante->id) }}"
        method="POST"
        ...
        <div class="mb-5">
            ...
            <input id="titulo" type="text" class="p-3 bg-gray-100 rounded form-input w-full @error('titulo') border-red-500 border @enderror" name="titulo" value="{{ $vacante->titulo }}">
            @error('titulo')
